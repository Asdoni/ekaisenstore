...
class Search(commands.Cog):
    ...
    @commands.command(
        name='anime', brief='Get information about an anime.', usage=f'`{prefix}anime <name>`',
        help=f'`{prefix}anime Hyouka`\n`{prefix}anime NHK ni Youkoso!`\n`{prefix}anime オレンジ`',
    ...
    @commands.command(name='manga', brief='Get information about a manga.', usage=f'`{prefix}manga <name>`',
                      description=desc,
                      help=f'`{prefix}manga Omniscient Reader`\n`{prefix}manga attack on titan`\n`{prefix}manga 東京卍リベンジャーズ`')
